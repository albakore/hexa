...
class RoleRepository(ABC):
	...
	@abstractmethod
	def link_grouplist_to_role(self, id_role:int, list_id_group: List[int]) -> Role | None: ...
	
	@abstractmethod
	def unlink_grouplist_to_role(self, id_role:int, list_id_group: List[int]) -> Role | None: ...
