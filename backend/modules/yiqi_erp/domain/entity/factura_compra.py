...
class FacturaDeCompra(YiqiEntity):
	...
	ESTADO_DE_VENCIMIENT : Optional[str] = Field(default=None, serialization_alias="6382")
	CANTIDAD_DE_DIAS_VEN : Optional[int] = Field(default=None, serialization_alias="6381")
	...
	TIPO_DE_CAMBIO_AL_PA : Optional[float] = Field(default=None, serialization_alias="5077")
	USD : Optional[float] = Field(default=None, serialization_alias="5131")
	COSTO_PROMEDIO_POR_K : Optional[float] = Field(default=None, serialization_alias="6601")
	COSTO_PROMEDIO_POR_I : Optional[float] = Field(default=None, serialization_alias="6602")
	...
	RETENCIONES_APLICADA : Optional[bool] = Field(default=None, serialization_alias="7050")
	...
	FECHA_PERIODO_DESDE : Optional[date] = Field(default=None, serialization_alias="2889")
	FECHA_PERIODO_HASTA : Optional[date] = Field(default=None, serialization_alias="2890")
	...
	NETO_DE_CONTROLADOR : Optional[float] = Field(default=None, serialization_alias="6475")
	...
	FECHA_DE_TC_AL_PAGO : Optional[date] = Field(default=None, serialization_alias="5078")
	...
	OBJECIONES_DE_TARIFA : Optional[str] = Field(default=None, serialization_alias="5481")
	ADJUNTO_TARIFA : Optional[int] = Field(default=None, serialization_alias="6449")
	OBJECIONES_DE_VOLUME : Optional[str] = Field(default=None, serialization_alias="5479")
	ADJUNTO_VOLUMEN : Optional[int] = Field(default=None, serialization_alias="6448")
	ENTRADA_CONTROL_VOLU : Optional[date] = Field(default=None, serialization_alias="5483")
	ENTRADA_CONTROL_TARI : Optional[date] = Field(default=None, serialization_alias="5484")
	ENTRADA_CONTROL_ADM : Optional[date] = Field(default=None, serialization_alias="5485")
	ENTRADA_A_MODIF_PEDI : Optional[date] = Field(default=None, serialization_alias="5538")
	RESPONSABLE_ADM : Optional[int] = Field(default=None, serialization_alias="6231")
	RESPONSABLE_CONTROL_ : Optional[int] = Field(default=None, serialization_alias="6230")
	...
	FECHA_DE_DETALLES_SO : Optional[date] = Field(default=None, serialization_alias="6906")
	...
	IMPORTE_RETENCION_1 : Optional[float] = Field(default=None, serialization_alias="6953")
	IMPUESTO_RETENCION_2 : Optional[float] = Field(default=None, serialization_alias="6956")
	...
	TRATADA_OBJ_VOLUMEN : Optional[bool] = Field(default=None, serialization_alias="5480")
	INICIO_DE_CONTROL : Optional[date] = Field(default=None, serialization_alias="5061")
	PEDIDO_DE_CAMBIO_INT : Optional[date] = Field(default=None, serialization_alias="5062")
	PEDIDO_DE_CAMBIO_AL_ : Optional[date] = Field(default=None, serialization_alias="5063")
	...
	ENTRADA_A_CONTROL_RE : Optional[date] = Field(default=None, serialization_alias="5489")
	...
	OBJECIONES_CONTROL_A : Optional[str] = Field(default=None, serialization_alias="6503")
	...
	SALDO_AJUSTADO_PROVE : Optional[float] = Field(default=None, serialization_alias="6247")
	...
	FECHA_EMISION_PROYEC : Optional[date] = Field(default=None, serialization_alias="5387")
	TIPO_DE_CAMBIO_ORIGI : Optional[float] = Field(default=None, serialization_alias="5075")
	...
	TOTAL_NOTA_DE_CREDIT : Optional[float] = Field(default=None, serialization_alias="5291")
	...
	CANCELACIONES_EN_PRO : Optional[float] = Field(default=None, serialization_alias="7229")
	...
	DIAS_EN_MODIF_PEDIDA : Optional[int] = Field(default=None, serialization_alias="5539")
	...
	DIAS_EN_CONTROL_REAL : Optional[int] = Field(default=None, serialization_alias="6390")
	TOTAL_NOTA_DE_DEBITO : Optional[float] = Field(default=None, serialization_alias="5292")
	TOTAL_PERCEPCIONES : Optional[float] = Field(default=None, serialization_alias="3146")
