...
from modules.finance.adapter.output.persistence.currency_adapter import CurrencyRepositoryAdapter
from modules.finance.adapter.output.persistence.sqlalchemy.currency import CurrencySQLAlchemyRepository
