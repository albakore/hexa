"""
Tests para los repositorios del módulo provider.
...
# from modules.provider.domain.entity.your_entity import YourEntity
# from modules.provider.adapter.output.persistence.your_adapter import YourRepositoryAdapter
