...
class AirWaybill(SQLModel, table=True):
	...
	fk_invoice: int | None = Field(default=None, description="ID de la factura de compra")
	...
	destination: str | None = Field(default=None, description="Destino de la guía aérea")
	kg: float | None = Field(default=None, description="Peso en kg")
	items: int | None = Field(default=None, description="Cantidad de ítems")
