...
from modules.provider.adapter.input.api.v1.request import DraftPurchaseInvoiceCreateRequest, DraftPurchaseInvoiceUpdateRequest
from modules.provider.container import DraftPurchaseInvoiceService
from modules.provider.domain.command import CreateDraftPurchaseInvoiceCommand, UpdateDraftPurchaseInvoiceCommand
...
async def get_draft_invoice_by_id(
	...
	invoice_with_metadata = await service.get_draft_purchase_invoice_with_filemetadata(invoice)
