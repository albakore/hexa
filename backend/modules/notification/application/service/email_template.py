...
class EmailTemplateService:
	...
	def __post_init__(self):
		self.usecase = EmailTemplateUseCaseFactory(
			self.email_template_repository, self.email_template_sender
		)
	...
	async def edit_email_template(self, id: int, command: EditEmailTemplateCommand):
		...
		email_template.sqlmodel_update(
			command.model_dump(exclude_unset=True, exclude_none=True)
		)
