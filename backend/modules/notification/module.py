...
class NotificationModule(ModuleInterface):
	...
	def service(self) -> Dict[str, object]:
		return {"notification_service": self._container.service,
	...
	def _setup_routes(self) -> APIRouter:
		...
		from .adapter.input.api.v1.notification import notifications_router as notifications_v1_router
		from .adapter.input.api.v1.email_template import email_templates_router as email_templates_v1_router
