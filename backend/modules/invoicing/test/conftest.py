...
from modules.invoicing.domain.repository.purchase_invoice import PurchaseInvoiceRepository
...
@pytest.fixture
def sample_purchase_invoice_with_id(sample_purchase_invoice_data: dict, random_int: int) -> PurchaseInvoice:
    """
...
@pytest.fixture
def invoice_usecase_factory(mock_purchase_invoice_repository: AsyncMock) -> InvoiceUseCaseFactory:
    """
...
@pytest.fixture
def purchase_invoice_service(mock_purchase_invoice_repository: AsyncMock) -> PurchaseInvoiceService:
    """
...
@pytest.fixture
def real_purchase_invoice_service(real_purchase_invoice_repository: PurchaseInvoiceRepositoryAdapter) -> PurchaseInvoiceService:
    """
