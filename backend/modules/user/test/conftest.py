"""
Fixtures específicos para los tests del módulo user.
"""
...
# from modules.user.domain.entity.your_entity import YourEntity
# from modules.user.domain.repository.your_repository import YourRepository
...
#     from modules.user.application.service.your_service import YourService
