...
from modules.notifications.adapter.input.api.v1.request import (
	CreateEmailTemplateRequest,
)
from modules.notifications.application.service.email_templates import (
...
from modules.notifications.domain.entity.email_templates import (
	EmailTemplate,
)
...
async def get_all_email_templates(
	email_templates_service: EmailTemplateService = Depends(
		Provide[NotificationsContainer.email_template_service]
	),
):
