...
class RBACRepositoryAdapter(RBACRepository):
	...
	async def get_all_permissions_from_role(self, role: Role) -> List[Permission] | Sequence[Permission]:
	...
	async def remove_permissions_to_role(self, permissions: List[Permission], id_role: int) -> int:
		return await self.role_repository.remove_permissions_to_role(permissions,id_role)
